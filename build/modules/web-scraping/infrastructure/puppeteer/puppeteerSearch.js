...
var SearchRepo = /** @class */ (function () {
    ...
    SearchRepo.prototype.executeSearch = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var page, response, status, body, resultProps, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, browser_1.puppeteerPage()];
                    case 1:
                        page = _a.sent();
                        return [4 /*yield*/, page.goto(url.props.EncodedURL || "")];
                    case 2:
                        response = _a.sent();
                    ...
                    case 3:
                        body = _a.sent();
                        resultProps = { httpStatus: status || 400, htmlBody: body };
                        result = searchResult_1.SearchResult.create(resultProps);
